<template>
  <div id="text-list-wrap" style="margin-top: 0.5rem">
    ...
    <div class="other-text-wrap">
      <comp-list-wrap @fetchData="fetchData" :config="config" :data="page.dataList" :noMore="page.noMore"
        max-height="calc(100vh - 175px)">
        <template #item="{ item, url, index }">
          <a-card hoverable @click="setBgImage(item)" class="cursor-pointer drop-shadow"
